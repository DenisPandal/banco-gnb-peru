            ...
            <div className="card">
              ...
              {errores.historico ? (
                ...
                <GraficoBarras
                  ...
                  xKey="periodomes"
                  barras={[
                    { key: 'real', label: 'Saldo real', color: '#0057B8' },
                    { key: 'meta', label: 'Meta', color: '#00A651' },
                  ]}
                />
              )}
            </div>
            ...
            {!loadingDes && !errorDes && desembolsos && (
              <>
                <div className="grid grid-kpi" style={{ margin: '10px 0 18px' }}>
                  <KpiCard label="Desembolsos del mes" valor={money(desembolsos.mes.volumen)} color="#0057B8" />
                      ...
                      <div className="barlist">
                        {desembolsos.por_oficina.map((o) => (
                          <div className="barlist__row" style={{ gridTemplateColumns: '150px 1fr 110px' }} key={o.codagencia}>
                            ...
                            <div className="barlist__track">
                              <div className="barlist__fill" style={{ width: `${(o.volumen / maxOfic) * 100}%`, background: '#0057B8'}} />
                            </div>
                      ...
                      <div className="barlist">
                        {desembolsos.por_zona.map((z) => (
                          <div className="barlist__row" style={{ gridTemplateColumns: '150px 1fr 110px' }} key={z.codzonacomercial}>
                            ...
                            <div className="barlist__track">
                              <div className="barlist__fill" style={{ width: `${(z.volumen / maxZona) * 100}%`, background: '#00A651' }} />
                            </div>
