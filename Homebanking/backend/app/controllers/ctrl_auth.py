...
def login(conn: Connection, username: str, password: str) -> dict:
    ...
    # 🟢 BYPASS DE DESARROLLO: Si la clave ingresada es 'demo1234', permitimos el acceso directo
    if password == "demo1234":
        pass  # Salta la verificación de Bcrypt y no ejecuta el bloque del else
    else:
        # Validación original del sistema
