# Banco GNB — Banca por Internet (Homebanking)

Portal del **cliente final** de Banco GNB, construido en **React 18 + Vite (JavaScript)**.
Consume el backend FastAPI del Homebanking que corre en `http://localhost:8002`.

> Identidad visual de **Banco GNB**: isotipo de flor andina multicolor, paleta del textil
...
1. **Login** — tarjeta centrada con logo Banco GNB sobre el gradiente de marca y franja tejida.
