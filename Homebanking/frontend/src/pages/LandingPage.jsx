...
const PRODUCTOS = [
  { icon: PiggyBank,    color: '#4CAF50', titulo: 'Cuenta de Ahorros',    desc: 'Maneja tu dinero sin costo de mantenimiento y gana intereses todos los días.' },
  { icon: Wallet,       color: '#1565C0', titulo: 'Cuenta Sueldo',        desc: 'Recibe tu sueldo, retira sin comisiones y accede a beneficios exclusivos GNB.' },
  { icon: BadgePercent, color: '#388E3C', titulo: 'Crédito de Consumo',   desc: 'El efectivo que necesitas con tasas preferenciales y cuotas a tu medida.' },
  { icon: Briefcase,    color: '#1976D2', titulo: 'Crédito Microempresa', desc: 'Impulsa tu negocio con financiamiento ágil pensado para emprendedores peruanos.' },
  { icon: Send,         color: '#2E7D32', titulo: 'Transferencias',       desc: 'Mueve tu dinero entre cuentas al instante, las 24 horas del día.' },
  { icon: CreditCard,   color: '#0D47A1', titulo: 'Tarjeta de Débito',    desc: 'Paga y compra en todo el país, en tiendas y por internet, con total seguridad.' },
]
...
const BENEFICIOS = [
  ...
  { icon: MapPin,      titulo: 'Respaldo internacional', desc: 'Grupo GNB con presencia en Colombia, Venezuela, Puerto Rico y Perú.' },
]
...
export default function LandingPage() {
  ...
  return (
    <div className="lp-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-text">
            <span className="lp-hero-tag">Banca Digital · Banco GNB Perú</span>
            <h1>Tu banca digital, <br />con respaldo internacional</h1>
            <p>
              Abre tu cuenta, paga tus créditos y transfiere tu dinero en minutos.
              Todo desde tu Banca por Internet GNB, con la seguridad que mereces.
            </p>
      ...
      <section className="lp-promo">
        <div className="lp-promo-inner">
          <div>
            ...
            <p>Sin papeleos ni colas. Pide tu crédito de consumo o microempresa desde tu Banca por Internet GNB y recibe una respuesta en evaluación al instante.</p>
          </div>
          <button className="lp-btn lp-btn-light" onClick={() => navigate('/login')}>
      ...
      {/* ===== BENEFICIOS ===== */}
      <section className="lp-section" id="beneficios" style={{ background: '#F5FAF5' }}>
        <div className="lp-section-head">
          <h2>¿Por qué elegir Banco GNB Perú?</h2>
          <p>Respaldo internacional con atención local para cada peruano.</p>
        </div>
          ...
          {BENEFICIOS.map((b) => {
            ...
            return (
              <div className="lp-benefit" key={b.titulo}>
                <div className="lp-benefit-icon"><Icon size={28} /></div>
                <h3>{b.titulo}</h3>
                <p>{b.desc}</p>
              </div>
            )
