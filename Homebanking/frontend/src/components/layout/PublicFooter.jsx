    ...
    <footer className="lp-footer" id="footer">
      <div className="lp-footer-inner">
        <div className="lp-footer-brand">
          ...
          <p>Tu banco con respaldo internacional. Operaciones 100% en línea, seguras y disponibles las 24 horas.</p>
        ...
        <div className="lp-footer-col">
          ...
          <ul className="lp-contact">
            <li><Phone size={15} /> Banca telefónica: (01) 311-9900</li>
            <li><Mail size={15} /> contacto@bancognb.pe</li>
            <li><MapPin size={15} /> Av. El Derby 250, Santiago de Surco, Lima</li>
          </ul>
        </div>
      </div>
      ...
      <div className="lp-footer-legal">
        © {new Date().getFullYear()} Banco GNB Perú S.A. — Banca por Internet. Demo educativo. Supervisado por la SBS.
      </div>
    </footer>
  )
}
